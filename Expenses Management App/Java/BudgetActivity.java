...
public class BudgetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Total Monthly Budget");
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (budgetItem.equals("Select item")) {
                    Toast.makeText(BudgetActivity.this, "Select a budget item", Toast.LENGTH_SHORT).show();
                }
                    ...
                    budgetRef.child(id).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(BudgetActivity.this, "Budget added successfully", Toast.LENGTH_SHORT).show();
                            } else {
